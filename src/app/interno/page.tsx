...
export default function InternoPage() {
  return (
    <div className="page-bg text-white h-full flex flex-col items-center justify-center gap-4 p-6 text-center">
      ...
      >
        <Building2 className="h-8 w-8" style={{ color: "var(--tab-accent-soft)" }} />
      </div>
      <div>
        <h1 className="font-heading text-2xl font-bold gradient-text text-glow-blue mb-2">Centro de Mando Digital Interno</h1>
