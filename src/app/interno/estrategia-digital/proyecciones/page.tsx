  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Kpi label="Alcance único estimado" value={formatNumber(totals.reach)} hint="Suma de impresiones ÷ frecuencia" color="#3b82f6" />
            ...
            <tbody>
              {channels.map((c) => (
                <tr key={c.channel} className="border-b border-white/5 hover:bg-white/3">
                  ...
                  <td className="px-4 py-2 text-right tabular-nums text-slate-400">{formatCOP(c.plannedBudget)}</td>
                  ...
                  <td className="px-4 py-2 text-right tabular-nums text-slate-400">{formatDecimal(c.frequency)}x</td>
